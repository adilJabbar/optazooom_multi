...
class Product extends Model
{
    ...
    protected $fillable = ['user_id','category_id','product_type','affiliate_link','sku', 'subcategory_id', 'childcategory_id', 'attributes', 'name', 'photo', 'size','size_qty','size_price', 'color', 'details','price','previous_price','stock','policy','status', 'views','tags','featured','best','top','hot','latest','big','trending','sale','features','colors','product_condition','ship','meta_tag','meta_description','youtube','type','file','license','license_qty','link','platform','region','licence_type','measure','discount_date','is_discount','whole_sell_qty','whole_sell_discount','catalog_id','slug','collection','thumbnail','quantity','fastener_type','tip','blade','sku_diameter_length','cleaner_colour','cloth_colour','pouch_colour','strength','lens','model','upc','part_number','legacy_number','brand','product_code','specification','impeller_mounting_hole','typee','usee','power','shape','style','diameter','package','screw_diamter','screw_length','screw_headtype','head_diamter','mateiral','current_price_detail','variation_images','material','short_details','color_price','strength_price','frame_color','frame_color_price','frame_size','frame_size_price','lens_price','bulk_price','eye','eye_price_extra','color_price_extra','title','title_price_extra','prescription_form'];
