...
Route::prefix('user')->group(function() {
  ...
  Route::post('/loginn', 'Controller@loginn')->name('user.login.submitt');
  // User Login End
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/', 'Controller@indexx')->name('front.index');
  ...
  Route::post('/addnumcartt','Front\CartController@addnumcartt');
