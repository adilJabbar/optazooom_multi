<li>
    ...
    <li>
        <a href="#menu3" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-user"></i>Practitioners
        </a>
        <ul class="collapse list-unstyled" id="menu3" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-user-index') }}"><span>Practitioners List</span></a>
            </li>
            <li>
                <a href="{{ route('admin-withdraw-index') }}"><span>{{ __('Withdraws') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-user-image') }}"><span>Practitioners Default Image</span></a>
            </li>
        </ul>
    </li>
    ...
    <li>
        <a href="#blog" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-fw fa-newspaper"></i>Opta-Blog
        </a>
        <ul class="collapse list-unstyled" id="blog" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-blog-index') }}"><span>Opta-News</span></a>
            </li>
        </ul>
    </li>
