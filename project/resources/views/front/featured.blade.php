		...
		<div class="info">
			...
			<h4 class="price">{{ $prod->showPrice() }} <del><small>{{ $prod->showPreviousPrice() }}</small></del></h4>
					...
					<div class="item-cart-area">
						...
						<span class="add-to-cart-btn" rel-toggle="tooltip" title="{{ $langg->lang56 }}" data-toggle="modal" id="wish-btn" data-target="#comment-log-reg" data-placement="right">
							<i class="icofont-heart-alt"></i>{{ $langg->lang56 }}
						</span>	
						<span class="add-to-cart-btn" rel-toggle="tooltip" title="{{ $langg->lang251 }}" data-toggle="modal" id="wish-btn" data-target="#comment-log-reg" data-placement="right">
